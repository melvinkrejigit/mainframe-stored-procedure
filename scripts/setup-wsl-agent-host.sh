...
sudo apt-get update
sudo apt-get install -y git unzip curl jq ca-certificates python3 python3-pip
...
echo "WSL agent host preinstall complete. Next run scripts/register-agent.sh."
